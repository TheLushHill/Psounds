...
from Training.GS_Model.module.mel_processing import spectrogram_torch
from Training.text import cleaned_text_to_sequence
from Training.GS_Model.utils import load_wav_to_torch, load_filepaths_and_text
...
class TextAudioSpeakerLoader(torch.utils.data.Dataset):
    ...
    def __init__(self, hparams, val=False):
        ...
        exp_dir1 = hparams.exp_dir1
        exp_dir2 = hparams.exp_dir2
        self.path2 = "%s/2_name2text_%s.txt" % (exp_dir1,0)
        self.path4 = "%s/4_cnhubert" % exp_dir2
        self.path5 = "%s/5_wav32k" % exp_dir2
